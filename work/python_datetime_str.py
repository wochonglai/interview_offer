...
# 方法将 datetime.datetime(2019, 5, 16, 10, 52, 8, 4939)转为2019-05-16 10:52:08.004939+08:00
now = datetime.now()
# tz_utc_8 = timezone(timedelta(hours=8)) # 创建时区UTC+8:00
# dt = now.replace(tzinfo=tz_utc_8) # 强制设置为UTC+8:00
# utc_dt = datetime.utcnow().replace(tzinfo=timezone.utc)
bj_dt = now.astimezone(timezone(timedelta(hours=8)))
print(bj_dt)
time_string=str(bj_dt).replace(' ','T')
